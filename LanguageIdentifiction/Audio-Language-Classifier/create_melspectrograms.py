...
def create_melspec(fold, train=8000, test=2000, n_fft = 2048, hop_length = 512, n_mels = 64, f_min = 20, f_max = 8000, sample_rate = 16000):
    ...
    counter = len(os.listdir(path=spectrogram_path_train))
    print(counter)
    ...
    for audio_file in wav_files:
        ...
        new_name = audio_file.replace(audio_file, f'{speaker[0]}{str(uuid.uuid4())}.png')
        ...
        if counter >= (train+test):
            ...
            print(f"COUNT {counter} - TOT {train+test}")
